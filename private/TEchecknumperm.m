...
if possiblepermutations < requiredpermutations
    fprintf('\n')
    warning(['TRENTOOL ERROR: The number of trials/subjects per condition (%d) is too small to allow ' ...
...
elseif possiblepermutations < requiredpermutations*20
    fprintf('\n')
    warning(['TRENTOOL WARNING: The number of trials/subjects per condition (%d) probably doesn''t' ...
